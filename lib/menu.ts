...
export const defaultMenuSections: MenuSection[] = [
  ...
  },
  {
    ...
    note: "Family-size sides and a la carte add-ons, available in multiple sizes. Ask staff for pricing.",
    items: [
      { id: "extras-sambar", name: "Sambar", description: "Rotates daily: Monday pumpkin sambar, Wednesday okra sambar, Thursday carrot & beans sambar, Friday onion sambar (and more depending on the day).", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Sambar"), tags: [] },
      { id: "extras-curry", name: "Curry", description: "Available only after 11:30am. Rotates daily: Monday cabbage & carrot poriyal, Wednesday beetroot curry (and more depending on the day).", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Curry"), tags: [], popular: true },
      { id: "extras-kootu", name: "Kootu", description: "Available only after 11:30am. Rotates daily: Monday aviyal (mixed vegetables), Wednesday spinach kootu (and more depending on the day).", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Kootu"), tags: [] },
      { id: "extras-rasam", name: "Rasam", description: "Available after 10:30am. Rotates daily: Monday lemon rasam, Wednesday pepper rasam, Thursday tomato rasam (and more depending on the day).", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Rasam"), tags: [] },
      { id: "extras-kara-kozhambu", name: "Kara Kozhambu", description: "Available only every Wednesday after 11:30am.", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Kara kozhambu"), tags: [] },
      { id: "extras-mor-kozhambu", name: "Mor Kozhambu", description: "Available only every Thursday after 11:30am.", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Mor kozhambu"), tags: [] },
      { id: "extras-buttermilk", name: "Buttermilk", description: "Creamy buttermilk with a tangy flavor, ideal for cooking, baking, or adding to beverages.", price: "", image: defaultImage("default-filter-coffee", "/images/filter-coffee.jpg", "Buttermilk"), tags: [] },
      { id: "extras-sweet", name: "Sweet", description: "Daily sweet special, recipe rotates by day.", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Sweet"), tags: [] },
      { id: "extras-coconut-chutney", name: "Coconut Chutney", description: "", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Coconut chutney"), tags: [] },
      { id: "extras-papped", name: "Papped", description: "Available only after 11:30am.", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Papped"), tags: [] },
      { id: "extras-yogurt", name: "Yogurt", description: "", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Yogurt"), tags: [] },
      { id: "extras-podi-ghee", name: "Podi (Spicy Powder) with Ghee", description: "", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Podi with ghee"), tags: [] },
      { id: "extras-podi-oil", name: "Podi (Spicy Powder) with Oil", description: "", price: "", image: defaultImage("default-south-indian-thali", "/images/south-indian-thali.jpg", "Podi with oil"), tags: [] },
    ],
  },
];
